...
activities = {
    ...
    "Basketball Club": {
        "description": "Skill development and pickup games for all levels",
    ...
    "Math Club": {
        ...
        "max_participants": 20,
        "participants": ["noelle@mergington.edu", "henry@mergington.edu"]
    },
    "Debate Team": {
        "description": "Prepare and compete in formal debates on varied topics",
        "schedule": "Mondays, 4:30 PM - 6:00 PM",
        "max_participants": 16,
        "participants": ["sarah@mergington.edu", "mateo@mergington.edu"]
    }
}
